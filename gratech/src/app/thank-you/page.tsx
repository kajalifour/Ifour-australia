        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
                 ...
                 <h2 className="wow fadeInUp text-white ty-title" data-wow-delay="200ms" data-wow-duration="1500ms">
                   Thank You!
                 </h2>
                 <p className="wow fadeInUp mt-3 text-white ty-subtitle" data-wow-delay="400ms" data-wow-duration="1500ms">
