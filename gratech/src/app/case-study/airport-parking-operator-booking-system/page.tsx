  ...
  return (
    <Wrapper>
      ...
      <main>
        ...
        <section className="case-single-area pt-120 pb-120">
          <div className="container">
            <div className="case-single__item" style={{ padding: '40px 0' }}>
              <h3 className="case-single__title mb-30" style={{ color: '#0f7a95', fontSize: '36px', fontWeight: 700 }}>Airport Parking Booking System</h3>
              <h4 className="mb-20" style={{ color: '#0f7a95', fontSize: '24px', fontWeight: 600 }}>Customer overview:</h4>
              ...
              <div className="row align-items-center g-4 mb-40" style={{ padding: '40px 0' }}>
                <div className="col-12">
                  ...
                  <div className="mb-4">
                    <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Reliable and Robust Booking Engine:</h4>
                    <p style={{ fontSize: '16px', lineHeight: 1.6 }}>A seamless and secure online booking engine, integrated with smooth payment gateway functionality, ensuring hassle-free transactions for customers.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Customized Content Management System:</h4>
                    <p style={{ fontSize: '16px', lineHeight: 1.6 }}>A user-friendly module empowering the customer to efficiently manage website content and updates, offering flexibility and control.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Dynamic Parking Location Management:</h4>
                    <p style={{ fontSize: '16px', lineHeight: 1.6 }}>An innovative module that dynamically allocates parking locations to members during check-in, optimizing space utilization and enhancing customer experience.</p>
                  </div>
                  ...
                  <div className="mb-4">
                    <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Affiliate and Referral Management:</h4>
                    <p style={{ fontSize: '16px', lineHeight: 1.6 }}>Efficient management of rewards and commissions for members who refer new customers, fostering customer loyalty and driving business growth.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Automated Report Generation:</h4>
                    <p style={{ fontSize: '16px', lineHeight: 1.6 }}>Comprehensive and dynamic reporting capabilities that provide detailed insights to parking facility managers, aiding in strategic decision-making.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>24/7 Online Chat Support:</h4>
                    <p style={{ fontSize: '16px', lineHeight: 1.6 }}>A dedicated online chat support system available round the clock to assist customers with their queries, enhancing their experience and satisfaction.</p>
                  </div>
                  
                  <div className="mb-4">
                    <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Secure Data Storage and Compliance:</h4>
                    <p style={{ fontSize: '16px', lineHeight: 1.6 }}>Ensuring the highest level of security, customer data is securely encrypted and stored, in compliance with government and industry regulations and standards.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="row align-items-center g-4 mb-40" style={{ padding: '40px 0' }}>
                ...
                <div className="col-lg-6">
                  <h3 className="case-single__title mb-20" style={{ color: '#0f7a95', fontSize: '32px', fontWeight: 700 }}>Technology stack:</h3>
                  <div className="technologies-list">
                    <div className="mb-3">
                      <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Type:</h4>
                      <p style={{ fontSize: '16px', lineHeight: 1.6 }}>Website</p>
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      ...
                      <p style={{ fontSize: '16px', lineHeight: 1.6 }}>Microsoft SQL Server</p>
                    </div>
                    <div className="mb-3">
                      <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Architecture:</h4>
                      <p style={{ fontSize: '16px', lineHeight: 1.6 }}>MVC / Entity framework</p>
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      ...
                      <p style={{ fontSize: '16px', lineHeight: 1.6 }}>SVN</p>
                    </div>
                    <div className="mb-3">
                      <h4 className="mb-2" style={{ color: '#0f7a95', fontSize: '18px', fontWeight: 600 }}>Payment Gateway:</h4>
                      <p style={{ fontSize: '16px', lineHeight: 1.6 }}>eWay Payment Gateway</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* How we work Section */}
        <section className="pt-120 pb-120" style={{ background: '#ffffff' }}>
          <div className="container">
