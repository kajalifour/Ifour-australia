...
const LifeCycleAssessmentSoftwareCaseStudy = () => {
  ...
  // Industry data
  const industry_data: Array<{ id: number; icon: string | null; title: string; link?: string }> = [
                ...
                <div className="col-lg-5">
                  <div className="image text-lg-end">
                    <Image 
                      ...
                      alt="Life Cycle Assessment Software Challenge" 
                      width={800} 
                      height={400} 
                    />
                  </div>
...
export default LifeCycleAssessmentSoftwareCaseStudy;
