...
const HeaderTopOne = () => {
   return (
      <div className="header-top d-none d-lg-block" style={{ backgroundColor: 'white' }}>
            ...
            <div className="header-top-wrp">
               <ul className="info">
                  <li><svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <Link href="#0" className="ms-1" style={{ color: '#0f7a95' }}>info@ifourtechnolab.com.au</Link>
                  </li>
                  <li className="ms-4"><svg width="16" height="15" viewBox="0 0 16 15" fill="none"
                     ...
                     <a href="#0" className="ms-1" style={{ color: '#0f7a95' }}>+61 4 8993 1698</a>
                  </li>
               </ul>
               <ul className="link-info">
                  <li><Link href="https://www.facebook.com/ifourtechnolab/"><i className="fa-brands fa-facebook-f" style={{ color: '#0f7a95' }}></i></Link></li>
                  <li><Link href="https://x.com/consultifour"><i className="fa-brands fa-twitter" style={{ color: '#0f7a95' }}></i></Link></li>
                  <li><Link href="https://www.linkedin.com/company/ifourtechnolab"><i className="fa-brands fa-linkedin-in" style={{ color: '#0f7a95' }}></i></Link></li>
                  <li><Link href="https://www.instagram.com/ifourtechnolab/"><i className="fa-brands fa-instagram" style={{ color: '#0f7a95' }}></i></Link></li>
               </ul>
            </div>
         </div>
      </div>
