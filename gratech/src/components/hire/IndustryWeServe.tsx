...
const IndustryWeServe = () => {
   return (
      <section className="industry-we-serve-area pt-120 pb-120" style={{ background: 'linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%)' }}>
