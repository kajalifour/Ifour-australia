    ...
    return (
        <>
            ...
            <style jsx global>{`
                ...
                .hire-cta-two-button:hover::before {
                    left: 100%;
                }
                
                .hire-cta-two-button:hover {
                    transform: translateY(-2px);
                    box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);
                    background: linear-gradient(135deg, #ffffff 0%, #e9ecef 100%);
                }
                
                .hire-cta-two-button:active {
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-8 text-center">
                            <div className="hire-cta-two-content">
                                <h2 
                                ...
                                <div className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    <Link href={buttonLink}>
                                        <button className="hire-cta-two-button">
                                            {buttonText}
                                        </button>
                                    </Link>
                                </div>
