      ...
      try {
        ...
        const publishedBlogs = blogData
          ...
          .map((blog: any) => {
            ...
            // Debug: log the fileName specifically
            console.log('Blog fileName:', blog.fileName);
               ...
               <div className="col-lg-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <Link href={`/blog/${blogs[0].slug}`} className="blog__image d-block image">
                  ...
                  <h3><Link href={`/blog/${blogs[0].slug}`} className="primary-hover">{blogs[0].postTitle}</Link></h3>
                    ...
                    <Link href={`/blog/${blogs[0].slug}`} className="btn-one">Read More <i className="fa-regular fa-arrow-right-long"></i></Link>
                        </div>
                     </div>
                  </div>
               </div>
              ...
              {blogs.slice(1, 3).map((item, index) => (
                <div key={item.id} className="blog-two__list-item mb-30 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                  <Link href={`/blog/${item.slug}`} className="blog__image d-block image">
                    ...
                    <div className="about__info mt-30 justify-content-between flex-wrap gap-3 d-flex align-items-center">
                      <div className="d-flex gap-2 align-items-center">
                        <Image src="/assets/images/blog/admin1.png" alt="image" width={50} height={50} />
                        <div className="info">
                          <Link href="#" className="primary-color">By Admin</Link>
                      ...
                      <Link href={`/blog/${item.slug}`} className="btn-one">Read More <i className="fa-regular fa-arrow-right-long"></i></Link>
                    </div>
                  </div>
                </div>
              ))
