...
const Brand = () => {
   return (
      <div className="brand-three-area pb-20">
         ...
         <div className="container">
            <div className="brand__wrp">
               <div className="section-header text-center mb-70">
                  <h2 className="wow fadeInLeft text-uppercase fa-2x" data-wow-delay="200ms" data-wow-duration="1500ms">
                     <span className="primary-color">Clients</span> We&#39;ve Served Thus Far
                  </h2>
               </div>
