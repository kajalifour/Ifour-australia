      ...
      <section id="blog-section" className="blog-area pt-120 pb-120">
        <div className="container">
          <div className="section-header text-center mb-60">
            ...
            <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Our Latest Insights</h2>
          </div>
                  ...
                  <div className="blog__content">
                    <ul className="blog-info pb-20 bor-bottom mb-20">
                      <li>
                        ...
                        <Link href="#0">By {item.authorName}</Link>
                      </li>
                      <li>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link className="mt-25 read-more-btn" href={`/blog/${item.slug}`}>Read More <i
