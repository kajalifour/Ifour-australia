...
const serviceDetailsData = {
    ...
    benefitsData: {
        ...
        additionalDescription: "At iFour, we strive to create long-term, mutually beneficial partnerships with our clients and develop ecommerce websites that help them stay ahead of the competition. Our ecommerce website development benefits include:",
