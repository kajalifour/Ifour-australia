...
// import service_data3 from "@/data/ServiceData";
                    ...
                    <div className="col-xl-6 wow fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div className="content-section">
                            <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style={{
                                ...
                                <span style={{ color: '#0f7a95' }}>Retail Software Development</span> Company Australia
                            </h2>
                        ...
                        <div className="about-two__right-item wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ marginRight: '0', transform: 'none', paddingLeft: '20px', paddingRight: '10px' }}>
                            <div className="section-header mb-30">
                                ...
                                <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{ color: '#ffffff', width: '100%', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                 At iFour, we are not just another software development company – we are your strategic partner in conquering the Australian market. Our team boasts an in-depth knowledge of the Australian landscape, giving us a unique advantage in crafting solutions that truly speak to your target audience. But we don't stop there! Embracing a global outlook, we stay ahead of the game by keeping a finger on the pulse of industry trends and cutting-edge technologies. With iFour, your software will not only meet Australian standards but will also soar to international acclaim.</p>                          
                                                          </div>
                            ...
                            <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{ color: '#ffffff', width: '100%', fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '30px' }}>
                               Ready to unlock the full potential of your Retail business? Contact us now
                            </p>
                           </div>
                              </div>
                           </div>
...
//                     {service_data3.filter((items: any) => items.page === "home_1").map((item: any) => (
                    ...
                    <div className="col-xl-6 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="section-header mb-40">
                            ...
                            <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ marginTop: '70px' }}>
                                <span style={{ color: '#0f7a95' }}>Our E-commerce development Services</span>
                                 </h2>
                                                        <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                              At iFour, more than 120 seasoned individuals make up our team, and they are enthusiastic about developing unique, custom software that helps organizations succeed in the rapidly evolving digital environment. 
Our professionals can assist you with:
                            ...
                            <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{ color: '#333', width: '100%', fontSize: '1.1rem', lineHeight: '1.8', marginTop: '20px' }}>
                                Contact us today to discuss your unique needs and how we can create a tailored solution to drive innovation and growth for your e-commerce business.
                            </p>
                                 </div>
                              </div>
                    <div className="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
