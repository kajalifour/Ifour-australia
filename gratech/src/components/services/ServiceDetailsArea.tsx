                    ...
                    <div className="col-xl-6 wow fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div className="content-section">
                            <h2 className="wow fadeInUp service-main-title" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <span className="text-teal">{data.title}</span> {data.subtitle || 'Services'}
                            </h2>
                ...
                <div className="row g-4">
                    <div className="col-xl-6 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="section-header mb-40">
                            ...
                            <h2 className="wow fadeInUp mt-70px" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <span className="text-teal">{data.aboutData?.title}</span> {data.aboutData?.subtitle}
                            </h2>
                                ...
                                <ul className="about-services-list">
                                    {data.aboutData.services.map((service, index) => (
                                        <li key={index} className="about-service-item">
                                            <span className="about-service-number">{index + 1}.</span>
                                            {service}
                                        </li>
                                    ))}
                                </ul>
                            ...
                            {data.aboutData?.additionalInfo && (
                                <p className="wow fadeInUp mt-20px" data-wow-delay="600ms" data-wow-duration="1500ms">
                                    {data.aboutData.additionalInfo}
                                </p>
                            )}
                        </div>
...
const MediaCoverageSection = ({ data }: { data: ServiceDetailsData }) => {
    ...
    return (
        <section className="media-coverage-area pt-120 pb-80 media-coverage-dark">
            <div className="container">
                <div className="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                    <div className="section-header">
...
const TechnologyPartnersSection = ({ data }: { data: ServiceDetailsData }) => {
    ...
    return (
        <section id="technology-partners-section" className="service-area pt-120 pb-120 technology-partners-bg mt-70px mb-70px">
            <div className="container">
                <div className="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                    <div className="section-header">
                        <h2 className="wow fadeInLeft text-white" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <span className="text-white">Our</span> Technology Partners
                        </h2>
                    </div>
                </div>
                
                <div className="technology-partners__container wow fadeInUp technology-partners-container" 
                    ...
                    <Image 
                        ...
                        width={800}
                        height={400}
                        className="technology-partners-image"
                    />
                </div>
            </div>
        </section>
                ...
                <div className="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                    <div className="section-header">
                        ...
                        Blog & news
                            ...
                            <h2 className="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ marginTop: '20px' }}>Explore Blogs and News</h2>
                        </div>
            ...
            <div className="container">
                <div className="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                    <div className="section-header">
                        ...
                        <h2 className="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ marginTop: '20px' }}>Explore Blogs and
                            News</h2>
                    </div>
                    <Link href="/blog" className="btn-one wow fadeInUp" data-wow-delay="200ms"
