        ...
        <section id="testimonial-section" className="testimonial-area pt-120 pb-120" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #f8f9fa 50%, #ffffff 100%)' }}>
            <div className="container">
                <div className="section-header mb-40">
                    ...
                    <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">We have added undeniable value to our clients' projects and ensured quantifiable results through our outcome-focused approach, ingenious thinking, and practical innovation.</p>
                </div>
            ...
            <div className="container">
                ...
                <div className="row g-4">
                    {bolg_data.filter((items) => items.page === "home_1").map((item) => (
                        <div key={item.id} className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="blog__item">
                                ...
                                <div className="blog__content">
                                    ...
                                    <Link className="mt-25 read-more-btn" href="/blog-details">Read More <i className="fa-regular fa-arrow-right-long"></i></Link>
                                </div>
                            </div>
                        </div>
                    ))}
