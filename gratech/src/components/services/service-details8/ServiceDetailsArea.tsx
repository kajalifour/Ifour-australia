                    ...
                    <div className="col-xl-6 wow fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div className="content-section">
                            <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style={{
                                ...
                                <span style={{ color: '#0f7a95' }}>IoT Application Development Services Australia</span> 
                            </h2>
                            <div className="text-content wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{
                               ...
                               Step into the world of IoT innovation with iFour, your trusted partner for bespoke IoT software development services in Australia. As a distinguished Microsoft Solutions Partner, we bring a wealth of expertise and credibility to every IoT project we undertake. </p>
                                <p style={{ marginBottom: '1.5rem' }}>
                               With over a decade of experience in the market, our team of over 120 skilled professionals is dedicated to crafting tailor-made IoT solutions that propel businesses forward in the dynamic digital landscape. </p>
                                <p style={{ marginBottom: '1.5rem' }}>
                              We understand the significance of combining local insights with global expertise, ensuring that our IoT offerings not only address your unique needs but also align with industry best practices. </p>
                                <p style={{ marginBottom: '1.5rem' }}>
                              Embrace exceptional IoT results that drive growth and set your business apart from the competition by choosing iFour as your technology partner on the path to IoT success. </p> 
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="col-xl-8">
                        <div className="cta-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style={{
                            ...
                            <h2 style={{ 
                                ...
                                Take your business to new heights with IoT software solutions.
                            </h2>
                    ...
                    <div className="col-xl-6 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="section-header mb-40">
                            ...
                            <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{ color: '#333', width: '100%', fontSize: '1.1rem', lineHeight: '1.8', marginTop: '20px' }}>
                                Reach out us today to discuss your requirements and let us drive innovation and growth for your organization.
                            </p>
                                 </div>
                              </div>
                    <div className="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
