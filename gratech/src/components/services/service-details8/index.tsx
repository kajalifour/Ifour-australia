...
const serviceDetailsData = {
    ...
    benefitsData: {
        ...
        additionalDescription: "At iFour, we strive to create long-term, mutually beneficial partnerships with our clients and develop IoT applications that help them stay ahead of the competition. Our IoT software development benefits include:",
