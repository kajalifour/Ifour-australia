...
const serviceDetailsData = {
    ...
    benefitsData: {
        ...
        additionalDescription: "At iFour, we strive to create long-term, mutually beneficial partnerships with our clients and develop Azure cloud solutions that help them stay ahead of the competition. Our Microsoft Azure cloud services benefits include:",
