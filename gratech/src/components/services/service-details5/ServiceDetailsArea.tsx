                    ...
                    <div className="col-xl-6 wow fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div className="content-section">
                            <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style={{
                                ...
                                <span style={{ color: '#0f7a95' }}>Software Development Company Australia</span> 
                            </h2>
                            <div className="text-content wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{
                               ...
                               iFour Technolab is a reliable partner for cloud computing and migration services. With over ten years of experience as a Microsoft Solutions Partner, we offer a depth of expertise and credibility to every project we tackle. We have developed our abilities and mastered our art, making us a dependable choice for organizations looking for high-quality software solutions. </p>
                                <p style={{ marginBottom: '1.5rem' }}>
                               We have more than 120 veteran experts that are passionate about developing creative and custom software solutions that move organizations forward in the ever-changing digital market. </p>
                                <p style={{ marginBottom: '1.5rem' }}>
                               As an Australian software firm, we realize the value of local knowledge and worldwide expertise in ensuring that our solutions not only satisfy your specific requirements but also adhere to industry best practices. </p>
                                <p style={{ marginBottom: '1.5rem' }}>
                               Contact us today to schedule a consultation and embark on your journey to the cloud with Microsoft Azure. Let us empower your Australian business with scalability, security, and innovation like never before. </p> 
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="about-two__right-item wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ marginRight: '0', transform: 'none', paddingLeft: '20px', paddingRight: '10px' }}>
                            <div className="section-header mb-30">
                                ...
                                <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ color: '#ffffff' }}>
                                    <span style={{ color: '#0f7a95' }}>Why Choose Microsoft Azure for Your Australian Business?</span> 
                                </h2>
                                ...
                                At iFour, we understand that modern businesses require flexible, scalable, and secure cloud solutions to stay ahead in today's competitive landscape. That's why we highly recommend Microsoft Azure, a cutting-edge cloud computing platform offering extensive services designed to elevate your business to new heights. Some of the benefits of Azure cloud services include: </p>                          
                                  </div>
                            ...
                            <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{ color: '#ffffff', width: '100%', fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '30px' }}>
                                Ready to scale your business with Microsoft Azure cloud solutions? Contact us right away to discuss your requirements. Our team of experts is eager to work with you, understand your plan, and deliver solutions that drive innovation and growth in your industry.
                            </p>
                             <p className="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" style={{ color: '#ffffff', width: '100%', fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '30px' }}>
                        ...
                        <div className="section-header mb-40">
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, margin: 0, marginTop: '15px' }}>
                                ...
                                <li style={{ marginBottom: '8px', color: '#333', fontSize: '0.9rem' }}>
                                 ...
                                 <li style={{ marginBottom: '8px', color: '#333', fontSize: '0.9rem' }}>
                                    <span style={{ color: '#0f7a95', marginRight: '8px', fontSize: '16px', fontWeight: 'bold' }}>9.</span>
