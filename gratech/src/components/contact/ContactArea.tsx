            ...
            <div className="row g-4">
               <div className="col-lg-5">
                  <div className="contact__left-item primary-bg">
                     ...
                     <p className="text-white">Nullam varius, erat quis iaculis dictum, eros urna varius eros, ut
                     ...
                     <ul className="mt-40 mb-40">
                        <li>
                           ...
                           <div>
                              ...
                              <h3 className="mt-1"><Link className="text-white" href="tel:+2085550112">+208-555-0112</Link>
                              </h3>
                           </div>
                        </li>
                        <li>
                           ...
                           <div>
                              ...
                              <h3 className="mt-1"><Link className="text-white" href="#">info@gmail.com</Link>
                              </h3>
                           </div>
                        </li>
                        <li>
                           ...
                           <div>
                              ...
                              <h3 className="mt-1"><Link className="text-white" href="tel:+2085550112">4517 Washington
                                 ave.</Link>
                              </h3>
                           </div>
                        </li>
                  ...
                  <div className="contact__right-item">
                     <div className="section-header mb-20">
                        ...
                        <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Ready to Get
                           Started?</h2>
                        <p className="wow fadeInUp mt-3" data-wow-delay="400ms" data-wow-duration="1500ms">Nullam
                           varius,
